...
class Thread1(QThread):
    ...
    def run(self):
        try:
            api_table = pd.read_csv('document/API_202110201754.csv', dtype={"APICD": str})
            operation_req_table = pd.read_csv('OPERATION_REQ_202110201814.csv', dtype={"APICD": str, "OPERCD": str})
            operation_res_table = pd.read_csv('OPERATION_RES_202110201814.csv', dtype={"APICD": str, "OPERCD": str})
